...
<body>
<canvas id="canvas" width="36" height="36" style="display: none;"></canvas><br>
    <div id="wrapper">
        ...
        function getCarlocation(type) {
            ...
            $.getJSON("/admin-transit/CM_CAR/API", function(jsonBus1) {
                ...
                $.each(jsonBus1, function(i, carB1) {
                    ...
                    // if(carB1.Type == type) {
                    //     console.log(carB1.Type);
                    //     var markBusB1 = new google.maps.Marker({
                    //         position: new google.maps.LatLng(carB1.LaGoogle, carB1.LongGoogle),
                    //         map: map,
                    //         title: carB1.Registerid,
                    //         icon: drawRotated(carB1.Direction)
                    //     });
                    //     carMark.push(markBusB1);
                    //     info = new google.maps.InfoWindow();
                    //     google.maps.event.addListener(markBusB1, 'click', (function (markBusB1, i) {
                    ...
                    if(type == null) {
                        ...
                        if(carB1.Type=="bus"||carB1.Type=="minibus"||carB1.Type=="kwvan") {
                            ...
                            if(car=="B1G"||car=="B1B"||car=="B2G"
                            ||car=="B2B"||car=="B3G"||car=="B3B")
                            {
                                bypass = true;
...
var i = 1;
        function drawRotated(degrees,route_code){
            ...
            if(route_code=="B1,2"||route_code=="B1,6"||route_code=="B1,3" ||route_code=="B1,1"||route_code=="B1,5"||route_code=="B1,4"
            ||route_code=="B2,5"||route_code=="B2,1"||route_code=="B2,4" ||route_code=="B2,6"||route_code=="B2,2"||route_code=="B2,3"){
                route_code = "Minibus"

                console.log(i,route_code);
                i++;
                if(i==13){
                    i = 1;
                }
